...
public class NativeWindowPlacementTests
{
    ...
    /// <param name="workAreaX">The target work-area left coordinate.</param>
    /// <param name="workAreaY">The target work-area top coordinate.</param>
    [Theory]
    [InlineData(320, 220, 900, 700, 0, 0)]
    [InlineData(3800, 200, 1750, 1225, 3440, 0)]
    [InlineData(3300, 200, 1750, 1225, 3440, 0)]
    public void MoveAndResizeMovesToTargetDisplayBeforeSizing(
        int x,
        int y,
        int width,
        int height,
        ...
        int workAreaY)
    {
        ...
        WindowBounds workArea = new(workAreaX, workAreaY, 2194, 1186);
